...
const I18N = {
  "zh-HK": {
    ...
    toastFavOn: "已加入最愛",
    toastFavOff: "已取消最愛",
    toastOwnedInc: "已標記為已擁有",
    toastOwnedDec: "已取消已擁有",
    ownToggleTip: "點擊切換「我已擁有」",
    bulkOwn: "☑ 全部標記擁有",
    bulkUnown: "☐ 全部清除擁有",
    bulkUnownConfirm: "確定清除目前篩選下所有卡的「已擁有」狀態？",
    bulkOwnDone: "已標記 {n} 張為已擁有",
    bulkUnownDone: "已清除 {n} 張的已擁有狀態",
    toastShare: "分享碼已複製",
  ...
  "zh-CN": {
    ...
    toastFavOn: "已加入最爱",
    toastFavOff: "已取消最爱",
    toastOwnedInc: "已标记为已拥有",
    toastOwnedDec: "已取消已拥有",
    ownToggleTip: "点击切换「我已拥有」",
    bulkOwn: "☑ 全部标记拥有",
    bulkUnown: "☐ 全部清除拥有",
    bulkUnownConfirm: "确定清除当前筛选下所有卡的「已拥有」状态？",
    bulkOwnDone: "已标记 {n} 张为已拥有",
    bulkUnownDone: "已清除 {n} 张的已拥有状态",
    toastShare: "分享码已复制",
  ...
  en: {
    ...
    toastOwnedInc: "Marked as owned",
    toastOwnedDec: "Removed owned",
    ownToggleTip: "Click to toggle owned",
    bulkOwn: "☑ Mark all owned",
    bulkUnown: "☐ Clear all owned",
    bulkUnownConfirm: "Clear the owned status of every card in the current filter?",
    bulkOwnDone: "Marked {n} cards as owned",
    bulkUnownDone: "Cleared owned status on {n} cards",
