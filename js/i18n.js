...
const I18N = {
  "zh-HK": {
    ...
    subtitle: "297 張官方卡資料（258 角色 + 39 Rush Point）· 官方 cardlist",
    langLabel: "語言",
    importBtn: "匯入 Deck",
    shareBtn: "複製分享碼",
    importTitle: "匯入牌組",
    ...
    simBattleBtn: "⚔️ 試玩對戰",
    simTitle: "牌組模擬器",
    exportImgBtn: "匯出 Deck 圖",
    exportImgComposition: "稀有度構成",
    exportImgQR: "掃描此 QR 匯入牌組",
    toastEmptyDeck: "牌組是空的，無法輸出",
    toastExportImg: "已輸出 Deck 一覽圖",
    simEmpty: "牌組是空的 — 先加些卡片吧！",
    simClickHint: "點擊卡片查看詳細資料",
    promptDeckName: "牌組名稱：",
    defaultDeckName: "預設牌組",
    importedDeckName: "匯入牌組",
    importedSuffix: "（imported）",
    toastUrlImported: "已從連結匯入牌組並建立新牌組（原有牌組未被覆寫）",
    ...
    startBtn: "開始使用",
    donateBtn: "☕ 支持我",
    wn1: "Deck 一覽圖輸出：一鍵匯出整副牌組 PNG（Deck 名 + 稀有度構成 + 全部卡圖）",
    wn2: "QR Code 匯入：一掃即自動載入牌組（分享碼已壓縮 -73%，手機可掃）",
    wn3: "卡庫 297 張：258 角色 + 39 Rush Point 圖鑑（EB01 / PB01 / TB01 新系列）",
    noMatch: "沒有符合的卡片。",
    // modal
    effectLabel: "效果",
    attrLabel: "顏色",
  ...
  "zh-CN": {
    appTitle: "Marvel Hero Rush Deck Builder",
    subtitle: "297 张官方卡资料（258 角色 + 39 Rush Point）· 官方 cardlist",
    langLabel: "语言",
    importBtn: "导入 Deck",
    shareBtn: "复制分享码",
    importTitle: "导入牌组",
    ...
    simTitle: "牌组模拟器",
    exportImgBtn: "导出牌组图",
    exportImgComposition: "稀有度构成",
    exportImgQR: "扫描此 QR 导入牌组",
    toastEmptyDeck: "牌组是空的，无法输出",
    toastExportImg: "已输出牌组一览图",
    simEmpty: "牌组是空的 — 先加点卡吧！",
    simClickHint: "点卡看详细资料",
    promptDeckName: "牌组名称：",
    defaultDeckName: "默认牌组",
    importedDeckName: "导入牌组",
    importedSuffix: "（imported）",
    toastUrlImported: "已从链接导入牌组，并新建了一个牌组（原有牌组未被覆盖）",
    ...
    startBtn: "开始使用",
    donateBtn: "☕ 支持我",
    wn1: "牌组一览图输出：一键导出整副牌组 PNG（牌组名 + 稀有度构成 + 全部卡图）",
    wn2: "QR Code 导入：一扫即自动载入牌组（分享码已压缩 -73%，手机可扫）",
    wn3: "卡库 297 张：258 角色 + 39 Rush Point 图鉴（EB01 / PB01 / TB01 新系列）",
    noMatch: "无吻合卡片。",
    effectLabel: "效果",
    attrLabel: "颜色",
    featureLabel: "特征",
  ...
  en: {
    appTitle: "Marvel Hero Rush Deck Builder",
    subtitle: "297 official cards (258 characters + 39 Rush Points) · official cardlist",
    langLabel: "Language",
    ...
    simBattleBtn: "⚔️ Battle Test",
    simTitle: "Deck Simulator",
    exportImgBtn: "Export Deck Image",
    exportImgComposition: "Rarity composition",
    exportImgQR: "Scan to import this deck",
    toastEmptyDeck: "Deck is empty — nothing to export",
    toastExportImg: "Deck overview image exported",
    ...
    importedSuffix: "（imported）",
    toastUrlImported: "Deck imported from link — created a new deck (your existing decks were NOT overwritten)",
    ...
    startBtn: "Start",
    donateBtn: "☕ Support",
    wn1: "Deck overview export: one-click PNG of the whole deck (name + rarity composition + all cards)",
    wn2: "QR Code import: scan to auto-load the deck (share code compressed -73%, phone-friendly)",
    wn3: "297-card database: 258 characters + 39 Rush Point gallery (EB01 / PB01 / TB01 new sets)",
