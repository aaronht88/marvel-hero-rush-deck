...
const I18N = {
  "zh-HK": {
    ...
    tabDonation: "支持",
    donTitle: "請我飲杯咖啡",
    donBody: "呢個 deck builder 係免費嘅 fans 工具。如果你覺得有用，可以用以下方式請我飲杯咖啡 ☕ 支持一下！",
    donBmc: "Buy me a coffee ☕",
    donOr: "或者",
    donPayme: "PayMe 撳入過數",
    donAlipay: "AlipayHK 掃碼支持",
  ...
  "zh-CN": {
    ...
    tabDonation: "支持",
    donTitle: "请我喝杯咖啡",
    donBody: "这个 deck builder 是免费的粉丝工具。如果你觉得有用，可以用以下方式请我喝杯咖啡 ☕ 支持一下！",
    donBmc: "Buy me a coffee ☕",
    donOr: "或者",
    donPayme: "PayMe 点击转账",
    donAlipay: "AlipayHK 扫码支持",
  ...
  en: {
    ...
    donBody: "This deck builder is a free fan-made tool. If you find it useful, you can buy me a coffee ☕ to show some love!",
    donBmc: "Buy me a coffee ☕",
    donOr: "or",
    donPayme: "PayMe — tap to pay",
    donAlipay: "AlipayHK — scan to support",
